            ...
            <table class="table">
                <thead class="table__head">
                    <tr>
                        ...
                        <th class="table__th">Duraci贸n</th>
                        <th class="table__th">Descripci贸n</th>
            ...
            <form action="" class="Plans__create" id="crearPlan">
                <div class="plans__container">
                    ...
                    <div class="plans__inputs">
                        ...
                        <input type="text" name="" id="duracionPlan" placeholder="Ingrese duraci贸n en d铆as" maxlength="3" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                    </div>
                    <div class="plans__inputs">
                        <label for="">Descripci贸n</label>
                        <input type="text" name="" id="descripcionPlan" placeholder="Ingrese breve descripci贸n">
                    </div>
                </div>
    ...
    <section class="modal">
        <div class="modal__container">
            ...
            <form action="" method="post" class="modal__form">
                ...
                <div class="modal__input">
                    <label for="">Duraci髇:</label>
                    <input type="text" value="Ejemplo">
                </div>
                <div class="modal__input">
                    <label for="">Descripci髇:</label>
                    <input type="text" value="Ejemplo">
                </div>
                <div class="modal__input">
